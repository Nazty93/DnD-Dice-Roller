...
def roll_dice(sides):
    ...
    try:
        ...
        if num_dice <= 0:
            ...
            result_label.config(text="Enter a number of dice less than 25.")
            return 
    except ValueError:
    ...
    if add_rolls == 'true':
        total = sum(rolls)
        result_label.config(text=f'Rolls: {rolls} | Total: {total}')
...
bg_image = Image.open('c:/Users/iblee/Resume Projects/DiceRollBackGround.jpg')
